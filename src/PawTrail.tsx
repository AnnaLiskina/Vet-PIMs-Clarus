// Single source of truth for the paw-print loading animation.
// Logic, positions, timing, easing and rendering are taken verbatim from
// src/imports/App-2.tsx — only the import paths and export name differ.
import { useEffect, useRef, useState } from "react";
import svgPathsSmall from "./imports/imports/Vector/svg-5zm4tbzhmb";
import svgPathsLarge from "./imports/imports/Vector-1/svg-n7gbk97bcx";
...
// Exported as PawTrail so both loading screens share one implementation.
// Callers supply their own background/container; this renders only the
// 400×320 animation canvas.
