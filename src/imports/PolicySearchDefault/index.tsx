import svgPaths from "./svg-iatzsk4yky";
...
function EmailLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Email label container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">Client’s name</p>
    </div>
  );
}
...
function EmailInputFieldContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Email input field container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#8a95a1] text-[14px] whitespace-nowrap">Enter Client’s name</p>
    </div>
  );
}
...
function EmailLabelContainer1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Email label container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">Address</p>
    </div>
  );
}
...
function EmailInputFieldContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Email input field container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#8a95a1] text-[14px] whitespace-nowrap">Enter Client’s address</p>
    </div>
  );
}
...
function EmailLabelContainer2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Email label container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">Policy number</p>
    </div>
  );
}

function EmailInputFieldContainer2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Email input field container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#8a95a1] text-[14px] whitespace-nowrap">Enter policy number</p>
    </div>
  );
}
...
function EmailLabelContainer3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Email label container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">Insurer</p>
    </div>
  );
}

function EmailInputFieldContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Email input field container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#8a95a1] text-[14px] whitespace-nowrap">Enter insurer</p>
    </div>
  );
}
...
function EmailLabelContainer4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Email label container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">Pet’s name (optional)</p>
    </div>
  );
}

function EmailInputFieldContainer4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Email input field container">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#8a95a1] text-[14px] whitespace-nowrap">Enter pet’s name</p>
    </div>
  );
}
...
export default function PolicySearchDefault() {
  return (
    <div className="bg-[#f4f6f9] relative size-full" data-name="Policy Search default">
      ...
      <Footer />
      <Frame2 />
      <div className="absolute bg-[#fc4d22] h-[44px] left-[876px] rounded-[6px] top-[570px] w-[280px]" data-name="Button">
