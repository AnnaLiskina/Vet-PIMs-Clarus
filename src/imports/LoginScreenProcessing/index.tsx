import svgPaths from "./svg-46gypomub5";
import { imgChevronDown, imgProgressActivity } from "./svg-kblwh";
...
function InputContainerL({ className, helperText = true, state = "Filled" }: InputContainerLProps) {
  const isFilledAndHelperText = state === "Filled" && helperText;
  const isFilledAndNotHelperText = state === "Filled" && !helperText;
  return (
    <div className={className || "relative w-[420px]"}>
      <div className={`size-full ${isFilledAndNotHelperText ? "overflow-clip rounded-[inherit]" : "content-stretch flex flex-col gap-[4px] items-start relative"}`}>
        {isFilledAndHelperText && (
          <>
            ...
            <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[12px] min-w-full not-italic relative shrink-0 text-[#6e7a87] text-[12px] w-[min-content]">Exceeds max characters</p>
          </>
        )}
        {isFilledAndNotHelperText && (
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="domain">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="domain">
          <mask height="16" id="mask0_0_51" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
...
function Frame() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Signing you in</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[344px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start pt-[32px] relative size-full">
        <InputContainerM />
        <InputContainerL className="opacity-50 relative shrink-0 w-[420px]" helperText={false} />
        <div className="opacity-50 relative shrink-0 w-[420px]" data-name="Input container / L">
        ...
        <div className="bg-[#fc4d22] h-[44px] relative rounded-[6px] shrink-0 w-full" data-name="Button">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] items-center justify-center pl-[20px] pr-[24px] py-[16px] relative size-full">
              <div className="relative shrink-0 size-[20px]" data-name="Icon / Updating / Outlined">
                <div className="absolute inset-[12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-3px] mask-size-[24px_24px]" style={{ maskImage: `url("${imgProgressActivity}")` }} data-name="progress_activity">
  ...
  return (
    <div className="absolute inset-[60.97%_-5.85%_-15.76%_69.72%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="496.955" preserveAspectRatio="none" viewBox="0 0 520.25 496.955" width="520.25">
        <g id="Group">
          <path d={svgPaths.p35d93640} fill="url(#paint0_linear_0_46)" fillOpacity="0.15" id="Vector" />
          <path d={svgPaths.p3a187100} fill="url(#paint1_linear_0_46)" fillOpacity="0.15" id="Vector_2" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_46" x1="0" x2="444.95" y1="250.804" y2="250.804">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_46" x1="259.029" x2="520.25" y1="193.541" y2="193.541">
            <stop stopColor="#FC4D22" />
            <stop offset="0.16" stopColor="#FC5223" />
            <stop offset="0.36" stopColor="#FC6026" />
            <stop offset="0.58" stopColor="#FD792C" />
  ...
  return (
    <div className="absolute inset-[-17.64%_73.96%_65.4%_-8.4%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" height="473.791" preserveAspectRatio="none" viewBox="0 0 496 473.791" width="496">
        <g id="Group">
          <path d={svgPaths.p2a174480} fill="url(#paint0_linear_0_43)" fillOpacity="0.05" id="Vector" />
          <path d={svgPaths.pb17b180} fill="url(#paint1_linear_0_43)" fillOpacity="0.05" id="Vector_2" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_43" x1="0" x2="424.21" y1="239.114" y2="239.114">
            <stop stopColor="#FC4D22" />
            <stop offset="0.16" stopColor="#FC5223" />
            <stop offset="0.36" stopColor="#FC6026" />
            <stop offset="0.58" stopColor="#FD792C" />
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_43" x1="246.955" x2="496" y1="184.52" y2="184.52">
            <stop stopColor="#FC4D22" />
            <stop offset="0.16" stopColor="#FC5223" />
            <stop offset="0.36" stopColor="#FC6026" />
            <stop offset="0.58" stopColor="#FD792C" />
  ...
  return (
    <div className="absolute h-[71px] left-[60px] top-[60px] w-[206px]" data-name="Logo / Clarus">
      <svg className="absolute block inset-0 size-full" fill="none" height="71" preserveAspectRatio="none" viewBox="0 0 206 71" width="206">
        <g id="Logo / Clarus">
          <path d={svgPaths.p66dbc00} fill="url(#paint0_linear_0_31)" id="Union" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_31" x1="65.0688" x2="68.1289" y1="33.3465" y2="25.4872">
...
export default function LoginScreenProcessing() {
  return (
