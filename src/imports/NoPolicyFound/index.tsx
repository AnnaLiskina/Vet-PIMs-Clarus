import svgPaths from "./svg-zgyqz65z9z";
...
import { imgSearch, imgSouth } from "./svg-4ylvy";
    ...
    <div className={className || "h-[80px] overflow-clip relative w-[264px]"}>
      <div className="absolute inset-[0.96%_72.86%_0_0]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="79.2327" preserveAspectRatio="none" viewBox="0 0 71.6474 79.2327" width="71.6474">
          <path d={svgPaths.p3cee3e00} fill="url(#paint0_linear_0_50)" id="Vector" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_50" x1="4.00305" x2="46.763" y1="30.8916" y2="74.7432">
      ...
      <div className="absolute inset-[0_68.26%_22.08%_15.8%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="62.3333" preserveAspectRatio="none" viewBox="0 0 42.0685 62.3333" width="42.0685">
          <path d={svgPaths.p5960b00} fill="url(#paint0_linear_0_35)" id="Vector" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_35" x1="62.9128" x2="67.9258" y1="36.3899" y2="23.1187">
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="help">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="help">
          <mask height="20" id="mask0_0_40" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
    ...
    <div className="absolute bg-white drop-shadow-[4px_10px_4px_rgba(0,0,0,0.25)] inset-[25.86%_0_0_0]">
      <div className="absolute inset-[25.58%_94.1%_25.09%_2.78%]" data-name="Union">
        <svg className="absolute block inset-0 size-full" fill="none" height="42.4199" preserveAspectRatio="none" viewBox="0 0 45 42.4199" width="45">
          <path d={svgPaths.p362e3500} fill="url(#paint0_linear_0_59)" id="Union" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_59" x1="22.4052" x2="45" y1="16.5206" y2="16.5206">
...
function PolicyNotFoundScreen() {
  return (
    <div className="bg-[#f2e4dd] content-stretch flex items-center justify-center relative rounded-[6px] shrink-0 size-[60px]" data-name="PolicyNotFoundScreen">
      <div className="relative shrink-0 size-[40px]" data-name="Icon / Search / Outlined">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
          <div className="absolute inset-[12.5%_14.27%_14.27%_12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-3px] mask-size-[24px_24px]" style={{ maskImage: `url("${imgSearch}")` }} data-name="search">
            <svg className="absolute block inset-0 size-full" fill="none" height="29.2917" preserveAspectRatio="none" viewBox="0 0 29.2917 29.2917" width="29.2917">
              <path d={svgPaths.pd8fe5c0} fill="#8A95A1" id="search" />
            </svg>
          </div>
        </div>
      </div>
...
function PolicyNotFoundScreenMargin() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[520px] right-[520px] top-[165px]" data-name="PolicyNotFoundScreen:margin">
      <PolicyNotFoundScreen />
    </div>
  );
}

function PolicyNotFoundScreenMargin1() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[431px] pt-[8px] right-[431px] top-[247px]" data-name="PolicyNotFoundScreen:margin">
      <div className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#252e38] text-[14px] text-center w-[573px] whitespace-pre-wrap">
        <p className="leading-[20px] mb-0">{`We couldn't find an active insurance policy matching your search. `}</p>
        <p className="leading-[20px]">The policy may be inactive, expired, or the client may not have current coverage.</p>
      </div>
    </div>
  );
}

function PolicyNotFoundScreen1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[44px] items-center min-w-px relative" data-name="PolicyNotFoundScreen">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#1c1919] text-[16px] whitespace-nowrap">This customer doesn’t have insurance.</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex h-[28px] items-center relative shrink-0 w-[418px]">
      <PolicyNotFoundScreen1 />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[20px] min-w-px not-italic relative text-[#1c1919] text-[14px]">You can refer this pet owner to insurance options through Clarus.</p>
    </div>
  );
}

function PolicyNotFoundScreenMargin2() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[8px] relative shrink-0 w-full" data-name="PolicyNotFoundScreen:margin">
      <Frame5 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[417px]">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] h-[34px] justify-center leading-[0] not-italic relative shrink-0 text-[#1c1919] text-[14px] w-[417px]">
        <p className="leading-[20px]">I confirm that the pet owner has given verbal consent to be contacted by insurance options.</p>
      </div>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[12px] h-[34px] items-start relative shrink-0 w-[445px]">
      <div className="bg-white relative rounded-[2px] shrink-0 size-[16px]" data-name="Checkbox">
        <div className="absolute border border-[#c4ccd4] border-solid inset-0 rounded-[2px]" data-name="checbox" />
      </div>
      <Frame1 />
    </div>
  );
...
function Frame8() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[40px] h-[192px] items-start left-[442px] p-[24px] rounded-[10px] top-[395px] w-[555px]">
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Submit Referral</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="[word-break:break-word] font-['Be_Vietnam_Pro:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#fc4d22] text-[14px] whitespace-nowrap">Back to Search</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[44px] items-center justify-center left-[442px] pl-[20px] pr-[24px] py-[16px] rounded-[6px] top-[619px] w-[144px]" data-name="Button">
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#556270] text-[14px] whitespace-nowrap">
          <p className="leading-[24px]">Reason for visit</p>
        </div>
      </div>
    </div>
  );
...
function Container1() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1c1919] text-[14px] whitespace-nowrap">
          <p className="leading-[24px]">Broken bone</p>
        </div>
      </div>
    </div>
  );
...
function ClaimTypeRow() {
  return (
    <div className="absolute bg-white content-stretch flex h-[44px] items-center justify-between left-[442px] pb-[9px] pt-[8px] px-[16px] right-[443px] rounded-[10px] top-[335px]" data-name="Claim type row">
      <div aria-hidden className="absolute border-[#dde3e8] border-b border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container />
      <Container1 />
    </div>
  );
...
export default function NoPolicyFound() {
  return (
    <div className="bg-[#f4f6f9] relative size-full" data-name="No Policy Found">
      ...
      <DesktopTopNav />
      <Footer />
      <PolicyNotFoundScreenMargin />
      <PolicyNotFoundScreenMargin1 />
      <Frame8 />
      <div className="absolute bg-[#fc4d22] h-[44px] left-[815px] rounded-[6px] top-[619px] w-[182px]" data-name="Button">
